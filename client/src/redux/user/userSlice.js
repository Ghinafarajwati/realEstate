...
const userSlice = createSlice({
    ...
    reducers: {
        ...
        signInSuccess: (state, action) => {            //Action yaitu data yang kita terima dari database 
            state.user = action.payload                //Ini data yg kita dapatkan, ditempatkan ke state.user
            state.loading = false
            state.error = null
        },
